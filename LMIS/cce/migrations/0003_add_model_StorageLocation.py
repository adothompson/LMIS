...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cce_storagelocation', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True, related_name='cce_storagelocation_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True, related_name='cce_storagelocation_modified_by', null=True)),
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['cce.StorageLocation'], blank=True, related_name='children_storage_location', null=True)),
            ...
            ('capacity_uom', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UnitOfMeasurement'], blank=True, related_name='capacity_uom', null=True)),
            ...
            ('temperature_uom', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UnitOfMeasurement'], blank=True, related_name='temp_uom', null=True)),
    ...
    models = {
        ...
        'cce.storagelocation': {
            ...
            'capacity_uom': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.UnitOfMeasurement']", 'blank': 'True', 'related_name': "'capacity_uom'", 'null': 'True'}),
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '55'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'cce_storagelocation_created_by'", 'null': 'True'}),
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'cce_storagelocation_modified_by'", 'null': 'True'}),
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'to': "orm['cce.StorageLocation']", 'blank': 'True', 'related_name': "'children_storage_location'", 'null': 'True'}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'temperature_uom': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.UnitOfMeasurement']", 'blank': 'True', 'related_name': "'temp_uom'", 'null': 'True'}),
        ...
        'cce.storagelocationproblemlog': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'cce_storagelocationproblemlog_created_by'", 'null': 'True'}),
            ...
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'cce_storagelocationproblemlog_modified_by'", 'null': 'True'}),
        ...
        'cce.storagelocationtemplog': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'cce_storagelocationtemplog_created_by'", 'null': 'True'}),
            'date_time_logged': ('django.db.models.fields.DateTimeField', [], {}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'cce_storagelocationtemplog_modified_by'", 'null': 'True'}),
            'storage_location': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cce.StorageLocation']"}),
        ...
        'cce.storagelocationtype': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'cce_storagelocationtype_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'cce_storagelocationtype_modified_by'", 'null': 'True'}),
        ...
        'facilities.facility': {
            ...
            'facility_operators': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'null': 'True', 'to': "orm['core.Company']", 'symmetrical': 'False', 'related_name': "'facility_operators'"}),
