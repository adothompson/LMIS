...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'facilities.facility': {
            ...
            'facility_operators': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'null': 'True', 'to': "orm['core.Company']", 'related_name': "'facility_operators'"}),
