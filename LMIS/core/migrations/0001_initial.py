...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_unitofmeasurement', (
            ...
            ('rounding_precision', self.gf('django.db.models.fields.IntegerField')(null=True, max_length=2, blank=True)),
        ))
        ...
        db.create_table('core_address', (
            ...
            ('tag', self.gf('django.db.models.fields.CharField')(null=True, max_length=35, blank=True)),
            ('street', self.gf('django.db.models.fields.CharField')(null=True, max_length=35, blank=True)),
            ('zip', self.gf('django.db.models.fields.CharField')(null=True, max_length=15, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(null=True, max_length=35, blank=True)),
            ('subdivision', self.gf('django.db.models.fields.CharField')(null=True, max_length=10, blank=True)),
            ('country', self.gf('django.db.models.fields.CharField')(null=True, max_length=5, blank=True)),
        ))
        ...
        db.create_table('core_company', (
            ...
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Contact'], blank=True)),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Address'], blank=True)),
            ('header', self.gf('django.db.models.fields.CharField')(null=True, max_length=100, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.CompanyCategory'])),
            ('footer', self.gf('django.db.models.fields.CharField')(null=True, max_length=100, blank=True)),
        ))
        ...
        db.create_table('core_employee', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(null=True, to=orm['auth.User'], unique=True, blank=True)),
        ))
        ...
        db.create_table('core_programproduct', (
            ...
            ('price_currency', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Currency'], blank=True)),
        ...
        db.create_table('core_productitem', (
            ...
            ('mode_of_use', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.ModeOfAdministration'], blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(blank=True, max_length=100)),
            ('weight_per_unit', self.gf('django.db.models.fields.FloatField')(null=True, max_length=21, blank=True)),
    ...
    models = {
        ...
        'core.facility': {
            ...
            'facility_operators': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'facility_operators'", 'to': "orm['core.Company']", 'blank': 'True', 'symmetrical': 'False'}),
