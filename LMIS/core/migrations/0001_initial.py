...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_uomcategory', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_uomcategory_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_uomcategory_modified_by')),
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, to=orm['core.UOMCategory'], null=True, related_name='core_uomcategory_sub_uom_categories')),
        ...
        db.create_table('core_unitofmeasurement', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_unitofmeasurement_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_unitofmeasurement_modified_by')),
            ...
            ('rounding_precision', self.gf('django.db.models.fields.IntegerField')(max_length=2, blank=True, null=True)),
        ))
        ...
        db.create_table('core_rate', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_rate_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_rate_modified_by')),
        ...
        db.create_table('core_currency', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_currency_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_currency_modified_by')),
        ...
        db.create_table('core_contact', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_contact_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_contact_modified_by')),
        ...
        db.create_table('core_address', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_address_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_address_modified_by')),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True, null=True)),
            ('street', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True, null=True)),
            ('zip', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True, null=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=35, blank=True, null=True)),
            ('subdivision', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True, null=True)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True, null=True)),
        ))
        ...
        db.create_table('core_company', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_company_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_company_modified_by')),
            ...
            ('header', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True, null=True)),
            ('footer', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True, null=True)),
        ))
        ...
        db.create_table('core_companycategory', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_companycategory_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_companycategory_modified_by')),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, to=orm['core.CompanyCategory'], null=True, related_name='core_companycategory_sub_company_categories')),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ...
        db.create_table('core_employeecategory', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_employeecategory_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_employeecategory_modified_by')),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, to=orm['core.EmployeeCategory'], null=True, related_name='core_employeecategory_sub_employee_categories')),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ...
        db.create_table('core_employee', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_employee_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_employee_modified_by')),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=55, unique=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Contact'], null=True)),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Address'], null=True)),
            ('current_company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Company'], related_name='employees')),
            ('main_company', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Company'], null=True, related_name='core_employee_main_company_employees')),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.EmployeeCategory'])),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, to=orm['auth.User'], null=True, unique=True)),
        ))
        ...
        db.create_table('core_facilitytype', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_facilitytype_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_facilitytype_modified_by')),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=55, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, to=orm['core.FacilityType'], null=True, related_name='sub_facility_types')),
        ...
        db.create_table('core_facilitytypeapprovedproduct', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_facilitytypeapprovedproduct_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_facilitytypeapprovedproduct_modified_by')),
        ...
        db.create_table('core_facility', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, to=orm['core.Facility'], null=True, related_name='child_facilities')),
        ...
        db.create_table('core_warehousetype', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_warehousetype_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_warehousetype_modified_by')),
        ...
        db.create_table('core_warehouse', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_warehouse_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_warehouse_modified_by')),
        ...
        db.create_table('core_program', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_program_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_program_modified_by')),
        ...
        db.create_table('core_programproductallocationinfo', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_programproductallocationinfo_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_programproductallocationinfo_modified_by')),
        ...
        db.create_table('core_programproduct', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_programproduct_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_programproduct_modified_by')),
        ...
        db.create_table('core_facilityprogramsupported', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_facilityprogramsupported_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_facilityprogramsupported_modified_by')),
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Program'])),
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Facility'])),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ...
        db.create_table('core_facilitysupportedprogramproduct', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_facilitysupportedprogramproduct_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_facilitysupportedprogramproduct_modified_by')),
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Facility'])),
            ('program_product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ProgramProduct'])),
        ...
        db.create_table('core_supervisorynode', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_supervisorynode_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_supervisorynode_modified_by')),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=55, blank=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, to=orm['core.SupervisoryNode'], null=True, related_name='parent_supervisory_node')),
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Facility'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ...
        db.create_table('core_ordergroup', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_ordergroup_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_ordergroup_modified_by')),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=55, blank=True)),
        ...
        db.create_table('core_processingperiod', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_processingperiod_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_processingperiod_modified_by')),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
        ...
        db.create_table('core_productcategory', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_productcategory_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_productcategory_modified_by')),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, to=orm['core.ProductCategory'], null=True, related_name='sub_product_categories')),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ...
        db.create_table('core_product', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_product_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_product_modified_by')),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=55, unique=True)),
        ...
        db.create_table('core_productpresentation', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_productpresentation_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_productpresentation_modified_by')),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=55, unique=True)),
        ...
        db.create_table('core_modeofadministration', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_modeofadministration_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_modeofadministration_modified_by')),
        ...
        db.create_table('core_productitem', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_productitem_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Employee'], null=True, related_name='core_productitem_modified_by')),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=35, unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=55, unique=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Product'])),
            ...
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('weight_per_unit', self.gf('django.db.models.fields.FloatField')(max_length=21, blank=True, null=True)),
            ('weight_uom', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.UnitOfMeasurement'], null=True, related_name='product_item_weight_uom')),
            ('volume_per_unit', self.gf('django.db.models.fields.FloatField')(blank=True, null=True)),
            ('volume_uom', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.UnitOfMeasurement'], null=True, related_name='product_item_volume_uom')),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ))
    ...
    models = {
        ...
        'core.address': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_address_created_by'"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_address_modified_by'"}),
        ...
        'core.company': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_company_created_by'"}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_company_modified_by'"}),
        ...
        'core.companycategory': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_companycategory_created_by'"}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_companycategory_modified_by'"}),
        ...
        'core.contact': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_contact_created_by'"}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_contact_modified_by'"}),
        ...
        'core.currency': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_currency_created_by'"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_currency_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '35', 'unique': 'True'}),
        ...
        'core.employee': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Contact']", 'null': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_employee_created_by'"}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_employee_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '55', 'unique': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'to': "orm['auth.User']", 'null': 'True', 'unique': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'})
        },
        'core.employeecategory': {
            'Meta': {'object_name': 'EmployeeCategory'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_employeecategory_created_by'"}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_employeecategory_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '35', 'unique': 'True'}),
        ...
        'core.facility': {
            ...
            'facility_operators': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'symmetrical': 'False', 'to': "orm['core.Company']", 'null': 'True', 'related_name': "'facility_operators'"}),
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'to': "orm['core.Facility']", 'null': 'True', 'related_name': "'child_facilities'"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
        ...
        'core.facilityprogramsupported': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_facilityprogramsupported_modified_by'"}),
        ...
        'core.facilitysupportedprogramproduct': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_facilitysupportedprogramproduct_created_by'"}),
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Facility']"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_facilitysupportedprogramproduct_modified_by'"}),
        ...
        'core.facilitytype': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '35', 'unique': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_facilitytype_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '55', 'blank': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_facilitytype_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '35', 'unique': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'to': "orm['core.FacilityType']", 'null': 'True', 'related_name': "'sub_facility_types'"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'})
        },
        'core.facilitytypeapprovedproduct': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_facilitytypeapprovedproduct_created_by'"}),
            'facility_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.FacilityType']"}),
            'max_months_of_stock': ('django.db.models.fields.IntegerField', [], {}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_facilitytypeapprovedproduct_modified_by'"}),
            'program_product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.ProgramProduct']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'})
        },
        'core.modeofadministration': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_modeofadministration_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_modeofadministration_modified_by'"}),
        ...
        'core.ordergroup': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_ordergroup_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '55', 'blank': 'True'}),
            'member_facilities': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'symmetrical': 'False', 'to': "orm['core.Facility']", 'null': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_ordergroup_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '35', 'unique': 'True'}),
        ...
        'core.processingperiod': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_processingperiod_created_by'"}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_processingperiod_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '35', 'unique': 'True'}),
        ...
        'core.product': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '35', 'unique': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_product_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_product_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '55', 'unique': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'})
        },
        'core.productcategory': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_productcategory_created_by'"}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_productcategory_modified_by'"}),
        ...
        'core.productitem': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_productitem_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_productitem_modified_by'"}),
        ...
        'core.productpresentation': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '35', 'unique': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_productpresentation_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_productpresentation_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '55', 'unique': 'True'}),
        ...
        'core.program': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '25', 'unique': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_program_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '55', 'blank': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_program_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '35', 'unique': 'True'}),
        ...
        'core.programproduct': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_programproduct_created_by'"}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_programproduct_modified_by'"}),
            'price_currency': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Currency']", 'null': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Product']"}),
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Program']"}),
        ...
        'core.programproductallocationinfo': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_programproductallocationinfo_created_by'"}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_programproductallocationinfo_modified_by'"}),
        ...
        'core.rate': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_rate_created_by'"}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_rate_modified_by'"}),
        ...
        'core.supervisorynode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '25', 'unique': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_supervisorynode_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '55', 'blank': 'True'}),
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Facility']"}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_supervisorynode_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '25', 'unique': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'to': "orm['core.SupervisoryNode']", 'null': 'True', 'related_name': "'parent_supervisory_node'"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'})
        },
        'core.unitofmeasurement': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_unitofmeasurement_created_by'"}),
            'factor': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_unitofmeasurement_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '25', 'unique': 'True'}),
        ...
        'core.uomcategory': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_uomcategory_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_uomcategory_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'unique': 'True'}),
        ...
        'core.vvmstage': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_vvmstage_created_by'"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_vvmstage_modified_by'"}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'})
        },
        'core.warehouse': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_warehouse_created_by'"}),
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Facility']"}),
            'is_refrigerated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_warehouse_modified_by'"}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'})
        },
        'core.warehousetype': {
            'Meta': {'object_name': 'WarehouseType'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_warehousetype_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Employee']", 'null': 'True', 'related_name': "'core_warehousetype_modified_by'"}),
            'uuid': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'})
        },
        'locations.location': {
