...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_uomcategory', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_uomcategory_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_uomcategory_modified_by', null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['core.UOMCategory'], blank=True, related_name='core_uomcategory_sub_uom_categories', null=True)),
        ...
        db.create_table('core_unitofmeasurement', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_unitofmeasurement_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_unitofmeasurement_modified_by', null=True)),
        ...
        db.create_table('core_rate', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_rate_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_rate_modified_by', null=True)),
        ...
        db.create_table('core_currency', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_currency_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_currency_modified_by', null=True)),
        ...
        db.create_table('core_contact', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_contact_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_contact_modified_by', null=True)),
        ...
        db.create_table('core_address', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_address_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_address_modified_by', null=True)),
        ...
        db.create_table('core_company', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_company_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_company_modified_by', null=True)),
        ...
        db.create_table('core_companycategory', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_companycategory_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_companycategory_modified_by', null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['core.CompanyCategory'], blank=True, related_name='core_companycategory_sub_company_categories', null=True)),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ...
        db.create_table('core_employeecategory', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_employeecategory_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_employeecategory_modified_by', null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['core.EmployeeCategory'], blank=True, related_name='core_employeecategory_sub_employee_categories', null=True)),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ...
        db.create_table('core_employee', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_employee_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_employee_modified_by', null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=55)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Contact'], null=True)),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.Address'], null=True)),
            ('current_company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Company'], related_name='employees')),
            ('main_company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Company'], blank=True, related_name='core_employee_main_company_employees', null=True)),
        ...
        db.create_table('core_facilitytype', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_facilitytype_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_facilitytype_modified_by', null=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('description', self.gf('django.db.models.fields.CharField')(blank=True, max_length=55)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['core.FacilityType'], blank=True, related_name='sub_facility_types', null=True)),
        ...
        db.create_table('core_facility', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['core.Facility'], blank=True, related_name='child_facilities', null=True)),
        ...
        db.create_table('core_warehousetype', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_warehousetype_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_warehousetype_modified_by', null=True)),
        ...
        db.create_table('core_warehouse', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_warehouse_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_warehouse_modified_by', null=True)),
        ...
        db.create_table('core_program', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_program_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_program_modified_by', null=True)),
        ...
        db.create_table('core_programproductallocationinfo', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_programproductallocationinfo_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_programproductallocationinfo_modified_by', null=True)),
        ...
        db.create_table('core_programproduct', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_programproduct_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_programproduct_modified_by', null=True)),
        ...
        db.create_table('core_facilitysupportedprogram', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_facilitysupportedprogram_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_facilitysupportedprogram_modified_by', null=True)),
            ('program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Program'])),
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Facility'])),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ...
        db.create_table('core_facilitysupportedprogramproduct', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_facilitysupportedprogramproduct_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_facilitysupportedprogramproduct_modified_by', null=True)),
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Facility'])),
        ...
        db.create_table('core_supervisorynode', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_supervisorynode_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_supervisorynode_modified_by', null=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('description', self.gf('django.db.models.fields.CharField')(blank=True, max_length=55)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['core.SupervisoryNode'], blank=True, related_name='parent_supervisory_node', null=True)),
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Facility'])),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ...
        db.create_table('core_ordergroup', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_ordergroup_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_ordergroup_modified_by', null=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('description', self.gf('django.db.models.fields.CharField')(blank=True, max_length=55)),
        ...
        db.create_table('core_processingperiod', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_processingperiod_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_processingperiod_modified_by', null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
        ...
        db.create_table('core_productcategory', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_productcategory_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_productcategory_modified_by', null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('parent', self.gf('mptt.fields.TreeForeignKey')(to=orm['core.ProductCategory'], blank=True, related_name='sub_product_categories', null=True)),
            ('lft', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('rght', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('tree_id', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('level', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
        ...
        db.create_table('core_product', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_product_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_product_modified_by', null=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=55)),
        ...
        db.create_table('core_productpresentation', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_productpresentation_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_productpresentation_modified_by', null=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=55)),
        ...
        db.create_table('core_modeofadministration', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_modeofadministration_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_modeofadministration_modified_by', null=True)),
        ...
        db.create_table('core_productitem', (
            ...
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('uuid', self.gf('django.db.models.fields.CharField')(primary_key=True, max_length=36)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_productitem_created_by', null=True)),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Employee'], blank=True, related_name='core_productitem_modified_by', null=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=35)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=55)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Product'])),
            ...
            ('weight_uom', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UnitOfMeasurement'], blank=True, related_name='product_item_weight_uom', null=True)),
            ('volume_per_unit', self.gf('django.db.models.fields.FloatField')(blank=True, null=True)),
            ('volume_uom', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.UnitOfMeasurement'], blank=True, related_name='product_item_volume_uom', null=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')()),
        ))
    ...
    models = {
        ...
        'core.address': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_address_created_by'", 'null': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_address_modified_by'", 'null': 'True'}),
        ...
        'core.company': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_company_created_by'", 'null': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_company_modified_by'", 'null': 'True'}),
        ...
        'core.companycategory': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_companycategory_created_by'", 'null': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_companycategory_modified_by'", 'null': 'True'}),
        ...
        'core.contact': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_contact_created_by'", 'null': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'blank': 'True', 'max_length': '75'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_contact_modified_by'", 'null': 'True'}),
        ...
        'core.currency': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_currency_created_by'", 'null': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_currency_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
        ...
        'core.employee': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Contact']", 'null': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_employee_created_by'", 'null': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_employee_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '55'}),
        ...
        'core.employeecategory': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_employeecategory_created_by'", 'null': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_employeecategory_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
        ...
        'core.facility': {
            ...
            'facility_operators': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'blank': 'True', 'to': "orm['core.Company']", 'related_name': "'facility_operators'", 'null': 'True'}),
            ...
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'to': "orm['core.Facility']", 'blank': 'True', 'related_name': "'child_facilities'", 'null': 'True'}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
        ...
        'core.facilitysupportedprogram': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_facilitysupportedprogram_created_by'", 'null': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_facilitysupportedprogram_modified_by'", 'null': 'True'}),
        ...
        'core.facilitysupportedprogramproduct': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_facilitysupportedprogramproduct_created_by'", 'null': 'True'}),
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Facility']"}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_facilitysupportedprogramproduct_modified_by'", 'null': 'True'}),
        ...
        'core.facilitytype': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_facilitytype_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '55'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_facilitytype_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'to': "orm['core.FacilityType']", 'blank': 'True', 'related_name': "'sub_facility_types'", 'null': 'True'}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'primary_key': 'True', 'max_length': '36'})
        },
        'core.modeofadministration': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_modeofadministration_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_modeofadministration_modified_by'", 'null': 'True'}),
        ...
        'core.ordergroup': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_ordergroup_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '55'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_ordergroup_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
        ...
        'core.processingperiod': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_processingperiod_created_by'", 'null': 'True'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_processingperiod_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
        ...
        'core.product': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_product_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_product_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '55'}),
            'uuid': ('django.db.models.fields.CharField', [], {'primary_key': 'True', 'max_length': '36'})
        },
        'core.productcategory': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_productcategory_created_by'", 'null': 'True'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_productcategory_modified_by'", 'null': 'True'}),
        ...
        'core.productitem': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_productitem_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_productitem_modified_by'", 'null': 'True'}),
        ...
        'core.productpresentation': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_productpresentation_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_productpresentation_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '55'}),
        ...
        'core.program': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '25'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_program_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '55'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_program_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
        ...
        'core.programproduct': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_programproduct_created_by'", 'null': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_programproduct_modified_by'", 'null': 'True'}),
            'price_currency': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['core.Currency']", 'null': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Product']"}),
            'program': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Program']"}),
        ...
        'core.programproductallocationinfo': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_programproductallocationinfo_created_by'", 'null': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_programproductallocationinfo_modified_by'", 'null': 'True'}),
        ...
        'core.rate': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_rate_created_by'", 'null': 'True'}),
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_rate_modified_by'", 'null': 'True'}),
        ...
        'core.supervisorynode': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '25'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_supervisorynode_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '55'}),
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Facility']"}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_supervisorynode_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '35'}),
            'parent': ('mptt.fields.TreeForeignKey', [], {'to': "orm['core.SupervisoryNode']", 'blank': 'True', 'related_name': "'parent_supervisory_node'", 'null': 'True'}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'primary_key': 'True', 'max_length': '36'})
        },
        'core.unitofmeasurement': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_unitofmeasurement_created_by'", 'null': 'True'}),
            'factor': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_unitofmeasurement_modified_by'", 'null': 'True'}),
        ...
        'core.uomcategory': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_uomcategory_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'level': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'lft': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_uomcategory_modified_by'", 'null': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
        ...
        'core.vvmstage': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_vvmstage_created_by'", 'null': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_vvmstage_modified_by'", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'primary_key': 'True', 'max_length': '36'})
        },
        'core.warehouse': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_warehouse_created_by'", 'null': 'True'}),
            'facility': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Facility']"}),
            'is_refrigerated': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_warehouse_modified_by'", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'primary_key': 'True', 'max_length': '36'})
        },
        'core.warehousetype': {
            'Meta': {'object_name': 'WarehouseType'},
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_warehousetype_created_by'", 'null': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Employee']", 'blank': 'True', 'related_name': "'core_warehousetype_modified_by'", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'primary_key': 'True', 'max_length': '36'})
        }
    }
