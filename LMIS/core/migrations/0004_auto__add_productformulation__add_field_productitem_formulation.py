...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductFormulation'
        db.create_table('core_productformulation', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User'], blank=True, related_name='core_productformulation_created_by')),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User'], blank=True, related_name='core_productformulation_modified_by')),
        ...
        db.send_create_signal('core', ['ProductFormulation'])

        # Adding field 'ProductItem.formulation'
        db.add_column('core_productitem', 'formulation',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.ProductFormulation'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProductFormulation'
        db.delete_table('core_productformulation')

        # Deleting field 'ProductItem.formulation'
        db.delete_column('core_productitem', 'formulation_id')
    ...
    models = {
        ...
        'core.productformulation': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'core_productformulation_created_by'"}),
            'description': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100'}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['auth.User']", 'blank': 'True', 'related_name': "'core_productformulation_modified_by'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '55', 'unique': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'primary_key': 'True', 'max_length': '36'})
        },
        'core.productitem': {
