...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConsumptionRecordLine.program'
        db.add_column('inventory_consumptionrecordline', 'program',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Program']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConsumptionRecordLine.program'
        db.delete_column('inventory_consumptionrecordline', 'program_id')
    ...
    models = {
        ...
        'facilities.facility': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '55', 'blank': 'True'}),
            'facility_operators': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'facility_operators'", 'symmetrical': 'False', 'blank': 'True', 'to': "orm['core.Company']"}),
