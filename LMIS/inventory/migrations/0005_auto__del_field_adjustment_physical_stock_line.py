...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Adjustment.physical_stock_line'
        db.delete_column('inventory_adjustment', 'physical_stock_line_id')


    def backwards(self, orm):
        # Adding field 'Adjustment.physical_stock_line'
        db.add_column('inventory_adjustment', 'physical_stock_line',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.PhysicalStockCountLine']),
                      keep_default=False)
    ...
    models = {
        ...
        'facilities.facility': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '55', 'blank': 'True'}),
            'facility_operators': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'related_name': "'facility_operators'", 'symmetrical': 'False', 'to': "orm['core.Company']", 'blank': 'True'}),
