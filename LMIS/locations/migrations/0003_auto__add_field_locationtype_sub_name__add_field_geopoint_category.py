...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationType.sub_name'
        db.add_column(u'locations_locationtype', 'sub_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GeoPoint.category'
        db.add_column(u'locations_geopoint', 'category',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationType.sub_name'
        db.delete_column(u'locations_locationtype', 'sub_name')

        # Deleting field 'GeoPoint.category'
        db.delete_column(u'locations_geopoint', 'category')
