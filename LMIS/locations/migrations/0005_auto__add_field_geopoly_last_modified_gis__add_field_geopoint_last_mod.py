...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeoPoly.last_modified_gis'
        db.add_column(u'locations_geopoly', 'last_modified_gis',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'GeoPoint.last_modified_gis'
        db.add_column(u'locations_geopoint', 'last_modified_gis',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GeoPoly.last_modified_gis'
        db.delete_column(u'locations_geopoly', 'last_modified_gis')

        # Deleting field 'GeoPoint.last_modified_gis'
        db.delete_column(u'locations_geopoint', 'last_modified_gis')
    ...
    models = {
        u'locations.geopoint': {
            ...
            'last_modified_gis': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
